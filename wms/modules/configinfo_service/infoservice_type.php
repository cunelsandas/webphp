				...
				<?php
					...
					if($rs){
						while($data=mysqli_fetch_assoc($rs)){
							$id=$data['id'];
							$name=$data['name'];
							echo "<tr><td>$name</td><td><a href=\"main.php?_modid=".$modid."&_mod=".$_GET['_mod']."&type=type&id=".$id."\"><img src=\"../images/component/docs_16.gif\" border=\"0\" /></a>&nbsp;&nbsp;&nbsp;<a href=\"main.php?type=type&_modid=".$modid."&_mod=".$_GET['_mod']."&del=".$id."\" onclick=\"return confirm('คุณต้องการลบรายการนี้ใช่หรือไม่?');\"><img src=\"../images/component/del_16.gif\" border=\"0\"/></a></td></tr>";
						}
					}
				?>
				</table>
