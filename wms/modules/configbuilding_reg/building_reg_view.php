...
if(isset($_POST['btadd'])){
	$strupdate="Update tb_building_reg SET typewb='".$_POST['f_status']."',updatetime='".date("c")."' Where id='".$_GET['no']."'";
...
$sql="Select * From tb_building_reg Where id='".$_GET['no']."'";
$rs=rsQuery($sql);
...
<!--            <p>เรื่อง : --><?php //echo $row['subject'];?><!--</p>-->
            ...
            <p>ที่อยู่ : <?php echo $row['address'];?> จังหวัด <?php echo $row['province'];?></p>
            <p>เบอร์โทรศัพท์ : <?php echo $row['telephone'];?></p>
            <p>อีเมล์/Line ID : <?php echo $row['email'];?></p>
            <hr style="border:1px solid #c3c3c3">

            <h4 style="text-decoration: underline">ข้อมูลอาคาร</h4>
...
<button class="btn btn-info" type="submit" name="btadd">บันทึก</button>&nbsp;&nbsp;
        <i class="fa fa-print" aria-hidden="true"></i><a class="btn btn-default"  href="report/building/html_form01.php?id=<?php echo $row['id'];?>" target="_Blank">พิมพ์</a>&nbsp;&nbsp;
