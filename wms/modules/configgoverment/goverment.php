...
?>
<span style="right:12%;position:absolute;"><img src="../images/component/add_24.png"/>&nbsp;<?php echo"<a href=\"main.php?_modid=".$modid."&_mod=".$_GET['_mod']."&type=addnew\">เพิ่มรายการใหม่</a>";?></span>
<center>
...
<thead>
		<tr>
			<th width="55%" class="topleft">ชื่อ - นามสกุล</th>
			<th width="25%" align="center">ตำแหน่ง</th>
