...
<tr >
    ...
    <td width="70" align="center">การดำเนินการ</td>
...
$Query = rsQuery($sql); //คิวรี่คำสั่ง
	...
	if ($page > 1) {
		$back = $page - 1;
		echo "<a href=main.php?_mod=".$_GET['_mod']."&_modid=".$modid."&page=1> << </a>&nbsp;&nbsp;";
		echo "<a href=main.php?_mod=".$_GET['_mod']."&_modid=".$modid."&page=$back> < </a>&nbsp;&nbsp;";
			if ($start > 1) { echo "....."; }
	}
	$icount=1;
	For ($i=$start ; $i<=$end ; $i++) {
	...
	if ($page < $totalpage) {
		...
		echo "&nbsp;&nbsp;<a href=main.php?_mod=".$_GET['_mod']."&_modid=".$modid."&page=$next> > </a>";
		echo "&nbsp;<a href=main.php?_mod=".$_GET['_mod']."&_modid=".$modid."&page=$totalpage> >> </a>";
	}
		echo "</p>";
