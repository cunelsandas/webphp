...
<?php
$tablename = 'tb_corruption_2021';
$id = $_GET['id'];
$sql = 'SELECT * FROM tb_corruption_2021 WHERE id = '.$id;
$rs = rsQuery($sql);
...
<div class="container">
  <div class="col-md-12">
    ...
    <div class="panel panel-default">
      <div class="panel-body" style="border: solid 1px #c3c3c3;padding:12px;">
...
<!--        <p> อีเมล &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: --><?php //echo $row['email'] ?><!-- </p>-->
        ...
        <p> ที่อยู่ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $row['address'] ?></p>
            <p> ไอพี &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $row['post_ip'] ?></p>
      </div>
      <div class="col-md-6 col-sm-9">
      <h4><u>ผู้ถูกร้องเรียน</u></h4>

      <p> สังกัดหน่วยงาน &nbsp;&nbsp;&nbsp;&nbsp; :
      <?php
        $sql2 = "select * from tb_corruption_obj where id = $id";
        $rs2 = rsQuery($sql2);
      ...
      <p> ชื่อ &nbsp;&nbsp;&nbsp; : <?php echo $row['corruption_person'] ?> </p>
          <p> เรื่อง &nbsp;&nbsp;&nbsp; : <?php echo $row['subject'] ?> </p>
          <p> รายละเอียด &nbsp;&nbsp;&nbsp; : <?php echo $row['detail'] ?> </p>
      <p> วัน/เวลาที่ร้องเรียน &nbsp;&nbsp;&nbsp;&nbsp;: <?php echo DateTimeThai($row['created_at']) ?> น. </p>
    </div>
</div>
</div>
  </div>
  ...
  <div class="col-md-12" style="text-align:center">
    <div class="hes-gallery">
            ...
            while ($rows = mysqli_fetch_array($rss)){
                echo "<div style='height: auto ; margin-top: 10px'>";
...
<a class="btn btn-default"  href="report/corruption/html_form01.php?id=<?php echo $row['id'];?>" target="_Blank">พิมพ์คำร้อง</a>&nbsp;&nbsp;
