...
if(isset($_POST['btadd'])){
    $strupdate="Update tb_hotelreg SET typewb='".$_POST['f_status']."',updatetime='".date("c")."' Where id='".$_GET['no']."'";
...
<div class="container">
    <div class="col-md-10" style="text-align:center;">
        <h2>ข้อมูลการลงทะเบียนโรงแรม</h2>
    </div>
    <div class="row" style="border: solid 1px black;padding: 5px">
        <div class="w3-panel w3-border col-md-10">
            <div class="panel-body">
                ...
                <p>ชื่อโรงแรม : <b style="font-size: 20px"> <?php echo $row['name'];?></b></p>
                <p>ขื่อโรงแรมภาษาอังกฤษ: <b style="font-size: 16px"> <?php echo $row['name_eng'];?></b></p>
                ...
                <p>เช็คอิน : <?php echo $row['time_start'].'  เช็คเอ้าท์ :'.$row['time_end'].' น.';?></p>
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <select id="f_status" name="f_status" class="form-control">
                    ...
                    <option <?php if($selected == '2'){echo("selected");}?> value="2">ลงทะเบียนโรงแรมเรียบร้อยแล้ว</option>
                </select>
                <br>
            </div>
