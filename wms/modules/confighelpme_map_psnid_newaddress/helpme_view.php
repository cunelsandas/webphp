...
if(isset($_POST['btadd'])){
  $text = $_POST['mytextarea'];
	$strupdate="Update tb_help_maps SET typewb='".$_POST['f_status']."',result='$text',updatetime='".date("c")."' Where id='".$_GET['no']."'";
...
<div class="container">
    ...
    <div class="w3-panel w3-border col-md-10">
        <div class="panel-body">
            ...
            ?>
            <p>หมายเลขบัตรประจำตัวประชาชน : <?php echo $row['psnid'];?></p>
            <p>ที่อยู่ : <?php echo $row['home'] ;?> หมู่ <?php echo $row['moo'] ;?> ตำบล <?php echo $row['tumbol'] ;?> อำเภอ <?php echo $row['ampur'] ;?> จังหวัด <?php echo $row['province'] ;?> </p>
            <p>อีเมล์ : <?php echo $row['email'];?></p>
            <p>เบอร์โทรศัพท์ : <?php echo $row['telphone'];?> </p>
            <p>รายละเอียด :</p>
            <blockquote>
