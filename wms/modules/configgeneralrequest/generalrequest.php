...
<p style="margin-left:10px;">รายการแจ้งคำร้องทั่วไป</p><hr><br>
<?php
//$tablename="tb_generalrequest";
...
<tr >
	<th width="20%">ปรเภทคำร้อง</th>
	<th width="30%">&nbsp;รายการ</th>
	<th width="15%" align="center">วันที่แจ้ง</th>
	<th width="15%" align="center">สถานะ</th>
	<th width="20%" align="center">ปรับปรุง</th>
</tr>
<?php
...
$Query = rsQuery($sql); //คิวรี่คำสั่ง
	...
	if($totalp==0){
		...
		while($arr = mysqli_fetch_assoc($Query)){
			$typename=FindRS("select * from tb_generalrequest_type where id=".$arr['type'],"name");
	...
	if ($page > 1) {
		$back = $page - 1;
		echo "<a href=main.php?_mod=".$_GET['_mod']."&_modid=".$modid."&page=1><img src=\"images/bt_first.png\" style=\"width:50px;height:25px;border:0;vertical-align: text-bottom;\" align=top></a>&nbsp;&nbsp;";
		echo "<a href=main.php?_mod=".$_GET['_mod']."&_modid=".$modid."&page=$back><img src=\"images/bt_prev.png\" style=\"width:50px;height:25px;border:0;vertical-align: text-bottom;\"></a>&nbsp;&nbsp;";
			if ($start > 1) { echo "....."; }
	}
	$icount=1;
	For ($i=$start ; $i<=$end ; $i++) {
		...
		if ($i == $page ) {
			...
			echo "&nbsp;<a href=main.php?_mod=".$_GET['_mod']."&_modid=".$modid."&page=".$i." style=\"color:$bgcolor\"><font color=$bgcolor>".$i."</font></a>&nbsp;&nbsp;&nbsp;" ;
		}
		$icount++;
	}
	if ($page < $totalpage) {
		...
		echo "&nbsp;&nbsp;<a href=main.php?_mod=".$_GET['_mod']."&_modid=".$modid."&page=$next><img src=\"images/bt_next.png\" style=\"width:50px;height:25px;border:0;vertical-align: text-bottom;\"></a>";
		echo "&nbsp;<a href=main.php?_mod=".$_GET['_mod']."&_modid=".$modid."&page=$totalpage><img src=\"images/bt_last.png\" style=\"width:50px;height:25px;border:0;vertical-align: text-bottom;\"></a>";
	}
		echo "</p>";
