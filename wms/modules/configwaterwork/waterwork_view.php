...
if(isset($_POST['btadd'])){
	$strupdate="Update tb_waterwork SET typewb='".$_POST['f_status']."',updatetime='".date("c")."' Where id='".$_GET['no']."'";
...
<div class="container">
    <div class="col-md-10" style="text-align:center;">
        <h2>ข้อมูลแจ้งซ่อมประปาสาธารณะ</h2>
    </div>
...
<br>
    ...
    if ($rs1->num_rows>0){
        ...
        <div class="col-md-10" style="text-align:center;margin-top: 5%">
            <h2>รูปภาพบริเวณแจ้งซ่อมประปาสาธารณะ</h2>
...
<button class="btn btn-info" type="submit" name="btadd">บันทึก</button>&nbsp;&nbsp;
        <a class="btn btn-default"  href="report/waterwork/html_form01.php?id=<?php echo $row['id'];?>" target="_Blank">พิมพ์คำร้อง</a>&nbsp;&nbsp;
