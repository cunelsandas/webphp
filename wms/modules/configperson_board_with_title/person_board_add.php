<?php
	$file_no=($gloBoard_fileno-1);   // กำหนด array จำนวน file ที่ต้องการ  $glo...มาจากไฟล์ connect.ini.php
...
$sql="INSERT INTO $table(name,position,status,sid,nolist,history) Values('".EscapeValue($_POST['txtname'])."','".$_POST['type']."','$ac','".$_POST['show']."','".$_POST['txtnolist']."','".$_POST['mytextarea']."')";
	$rs=rsQuery($sql);
	if($rs){
...
<tr>
	...
	<td width="75%"><input type="text" size="70" class="txt1" name="txtname" /></td>
</tr>
<tr>
<td>ตำแหน่ง</td>
		<td><input type="text" class="txt1" name="type" id="type" />
		</td>
</tr>
<tr>
...
<tr>
	...
	<td><input type="text" class="txt1" name="txtnolist" /></td>
</tr>
<tr>
