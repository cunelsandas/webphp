...
<p style="margin-left:10px;">ส่วนราชการ</p><hr><br>
<?php
//$tablename="tb_publictype";
...
<p style="right:10%;position:absolute;"><?php echo"<a href=\"main.php?_modid=".$modid."&_mod=".$_GET['_mod']."&type=addnews\" class=\"link\">เพิ่มข้อมูลใหม่</a>";?></p>
...
<tr >
	<td width="70%" align="center">กลุ่มประชาคม</td>
	<td width="10%" align="center">ลำดับการแสดง</td>
...
$Query = rsQuery($sql1); //คิวรี่คำสั่ง
	...
	if($totalp==0){
		...
		while($arr = mysqli_fetch_assoc($Query)){
			...
			echo"</td>";
			echo"<td align=\"center\"><a href=\"main.php?_modid=".$modid."&_mod=".$_GET['_mod']."&type=view&id=".$arr['id']."\"><img src=\"../images/component/docs_16.gif\" border=\"0\" /></a>&nbsp;&nbsp;&nbsp;<a href=\"main.php?_modid=".$modid."&_mod=".$_GET['_mod']."&del=".$arr['id']."\" onclick=\"return confirm('คุณต้องการลบหัวข้อนี้หรือไม่?');\"><img src=\"../images/component/del_16.gif\" border=\"0\"/></a></td>";
			echo"</tr>";			
			$i++;
		}
	}
