...
if(isset($_POST['btadd'])){
	$strupdate="Update tb_help_maps SET typewb='".$_POST['f_status']."',result=".$_POST['mytextarea'].",updatetime='".date("c")."' Where id='".$_GET['no']."'";
...
$sql="Select * From tb_help_maps Where id='".$_GET['no']."'";
$rs=rsQuery($sql);
    ...
    <form name="form_help" id="form_help" method="POST" action="" enctype="multipart/form-data">
        ...
        <div class="col-md-4">
            ...
            <select id="f_status" name="f_status" class="form-control">
                ...
                <option <?php if($selected == '1'){echo("selected");}?> value="1">รับเรื่องและกำลังตรวจสอบ</option>
                <option <?php if($selected == '2'){echo("selected");}?> value="2">ตรวจสอบแล้วไม่มีมูล</option>
                <option <?php if($selected == '3'){echo("selected");}?> value="3">อยู่ระหว่างดำเนินการ</option>
...
<a class="btn btn-default"  href="report/helpme_map/html_form01.php?id=<?php echo $row['id'];?>" target="_Blank">พิมพ์คำร้อง</a>&nbsp;&nbsp;
