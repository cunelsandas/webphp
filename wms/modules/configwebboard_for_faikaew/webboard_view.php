...
<tr>
	<td colspan="2" align="left" >
		...
		<font id=text9-clay>&nbsp;&nbsp;โดย&nbsp;<?php echo $row['postby'];?>&nbsp;&nbsp;เบอร์โทร&nbsp;<?php echo $row['telephone'];?>&nbsp;&nbsp;E-mail&nbsp;<?php echo $row['email'];?>&nbsp;&nbsp;IP :<?php echo $row['ip'];?>&nbsp;&nbsp;วันที่ : <?php echo $row['updatetime'];?></font>&nbsp;&nbsp;&nbsp;
		<?php
