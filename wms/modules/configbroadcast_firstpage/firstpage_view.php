...
if(isset($_POST['btadd'])){
  // วนรับค่าจาก control
	...
	$sql="UPDATE $table SET subject='".$_POST['txtsubject']."',detail1='".$_POST['spaw1']."',weblink='".$_POST['weblink']."',linkname='".$_POST['linkname']."',datepost='".$_POST['dateInput']."',ip='".$_SERVER['REMOTE_ADDR']."',status='$ac',bg_color='".$_POST['bg_color']."' Where no='".$_GET['no']."'";
	$rs=rsQuery($sql);
	if($rs){
...
<tr >
	<td >รายละเอียด</td>
	<td><?php 
				$spaw = new SpawEditor("spaw1",$row['detail1'] );
				$spaw->show(); ?><!--<textarea name="detail1" class="txtarea"><?php echo $row['detail1'];?></textarea>-->
	</td>
</tr>
<tr >
	<td >Web Link</td>
