...
<p style="right:10%;position:absolute;"><?php echo"<a href=\"main.php?_modid=".$modid."&_mod=".$_GET['_mod']."&type=addnew\" class='link'>เพิ่มข้อมูลใหม่</a>";?></p>
<br>
<center>
...
<tr>
	...
	<th width="10%" align="center">รายละเอียด</th>
...
<?php
	...
	$sql1 = "select * from $tablename order by name ASC Limit $goto,$pagelen"; //ทำการแสดงผลโดยใช้คำสั่ง Limit เพื่อแสดงจำนวนข้อมูลต่อหน้า
