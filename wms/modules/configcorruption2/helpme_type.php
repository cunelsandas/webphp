...
<p style="right:10%;position:absolute;"><?php echo"<a href=\"main.php?_modid=".$modid."&_mod=".$_GET['_mod']."&type=addtype\" class=\"link\">เพิ่มประเภทคำร้อง</a>";?></p>
<br><br>
<center>
...
$Query = rsQuery($sql1); //คิวรี่คำสั่ง
	...
	if($totalp==0){
		...
		while($arr = mysqli_fetch_assoc($Query)){
			...
			echo"<td align=\"center\">&nbsp;&nbsp;<a href=\"main.php?_modid=".$modid."&_mod=".$_GET['_mod']."&deltype=".$arr['id']."\" onclick=\"return confirm('คุณต้องการลบหัวข้อข่าวนี้หรือไม่?');\"><img src=\"../images/component/del_16.gif\" border=\"0\"/></a></td>";
			echo"</tr>";
			$i++;
		}
	}
