...
?>
<p style="margin-left:10px;"><?php echo"<a href=\"main.php?_modid=".$modid."&_mod=".$_GET['_mod']."&type=addnew\" class='link'>เพิ่มรายการใหม่</a>";?></p>
<center>
...
<tr height="30" >
	<th width="330">&nbsp;รายการ</th>
	<th width="130" align="center">วันที่แจ้ง</th>
	<th width="50" align="center">สถานะ</th>
	<th width="70" align="center">ปรับปรุง</th>
</tr>
<?php
