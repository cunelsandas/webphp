			...
			<table width='100%'>
				...
				<tr>
					...
					<td>
							<select name='submenu'>
								<?php
									$sql="select * from tb_lpa_submenu_2563 order by menuid ASC ,listno ASC";
									$rsMenu=rsQuery($sql);
									if($rsMenu){
										while($dMenu=mysqli_fetch_assoc($rsMenu)){
											$id=$dMenu['id'];
                ...
                <tr>
					...
					<td>
							<select name='detailid'>
								<?php
									$sql="select * from tb_lpa_detail_2563 order by submenuid ASC ,listno ASC";
									$rsMenu=rsQuery($sql);
									if($rsMenu){
										while($dMenu=mysqli_fetch_assoc($rsMenu)){
											$id=$dMenu['id'];
