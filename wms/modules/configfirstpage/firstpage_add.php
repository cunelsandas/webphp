...
//	}
	...
	$sql="INSERT INTO $table(subject,detail1,weblink,linkname,datepost,ip,status,picture_main,picture_bg,bg_color) Values('".$_POST['txtsubject']."','".$_POST['mytextarea']."','".$_POST['weblink']."','".$_POST['linkname']."','".$_POST['dateInput']."','".$_SERVER['REMOTE_ADDR']."','$ac','','','".$_POST['bg_color']."')";
	$rs=rsQuery($sql);
	if($rs){
...
<tr>
	<td >รายละเอียด</td>
	<td>        <textarea type="text" class="form-control" name="mytextarea" id="mytextarea" style="width: 100%"></textarea>
    </td>
</tr>
<tr>
	<td >Web Link</td>
