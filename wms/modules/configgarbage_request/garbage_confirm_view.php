...
if (isset($_POST['btadd'])) {
    $strupdate = "Update tb_garbage_request_confirm SET typewb='" . $_POST['f_status'] . "',updatetime='" . date("c") . "' Where id='" . $_GET['no'] . "'";
...
$sql = "Select * From tb_garbage_request_confirm Where id='" . $_GET['no'] . "'";
$rs = rsQuery($sql);
...
<div class="container">
    <div class="col-md-10" style="text-align:center;">
        <h2>ข้อมูลผู้ขอรับบริการจัดเก็บขยะมูลฝอย</h2>
    </div>
    <div class="row" style="border: solid 1px black;padding: 5px">
        <div class="w3-panel w3-border col-md-10">
            <div class="panel-body">
                ...
                <hr>
                <h5 style="text-decoration: underline">ข้อมูลจุดรับบริการเก็บขยะมูลฝอย</h5>
                <p>หมู่ที่: <?php echo $row['moo']; ?> </p>
                <p>หมู่บ้าน: <?php echo $row['mooban']; ?> </p>
                <p>ที่อยู่/สถานที่/จุดสังเกต ที่ขอรับบริการ: <?php echo $row['placefocus']; ?> </p>
                <!--            <p>รายละเอียด :</p>-->
                <!--            <blockquote>-->
...
<!--        </div>-->
    ...
    if ($rs1->num_rows > 0) {
        ...
        <div class="col-md-10" style="text-align:center;margin-top: 5%">
            <h2>รูปภาพสำเนาบัตรประจำตัวประชาชน</h2>
