<script src="https://use.fontawesome.com/69559012a2.js"></script>
<div id="data_helpme">
    <?php
    ...
    //	$name_btn = "แจ้งปัญหา/เรื่องร้องเรียน";
    $name_btn = $modname;
...
//		echo"<a href='view.php' class='link' target='_blank'>".$name_btn."</a>";
            echo "<a href=\"index.php?_mod=" . $_GET['_mod'] . "&type=" . encode64('addnew') . " \" class='link' target='_blank'>" . $name_btn . "</a>";
        } else {
//            echo "<a href=\"index.php?_mod=" . $_GET['_mod'] . "&type=" . encode64('addnew') . " \" class='link'>" . $name_btn . "</a>";
            echo "<a href=\"index.php?_mod=" . $_GET['_mod'] . "&type=" . encode64('addnew') . " \" class='link'><i style='font-size:4em' class='fa fa-plus-circle' aria-hidden='true'></i></a>";
        }

        echo "<br>";
        echo "<br>";
        echo "<p>".$tel_nayok."</p>";
        echo "<p>".$tel_nayok_phone."</p>";
