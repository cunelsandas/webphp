...
<div class="container" style="border: 1px solid #c3c3c3;border-radius: 12px">
    <div class="panel panel-default col-md-12">
        <h2>ข้อมูลแจ้งขอยกเลิกการรับบริการจัดเก็บขยะมูลฝอย</h2>
        <div class="panel-body">
            <p>เลขที่แจ้งขอยกเลิกบริการ : <?php echo $row['id'];?></p>
            ...
            <!--            <p>รหัส/หมายเลขเสา (ถ้ามี) : --><?php //echo $row['pole_id'];?><!--</p>-->
            <p>บริเวณแจ้งขอยกเลิกการรับบริการ: <?php echo $row['placefocus'];?></p>
            <p>สถานะงาน : <?php echo $processname ?>
        </div>
    </div>
