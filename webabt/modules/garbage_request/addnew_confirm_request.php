...
//            echo "<script>alert('Send Mail OK1')</script>";
            ...
            $sql = "INSERT INTO tb_garbage_request_confirm(id,code,name,id_card,telephone,email,address,province,moo,mooban,placefocus,lat,lng,datepost,ip,typewb,status,updatetime,image_key) Values('',1,'".$_POST['f_name']. "','" .$_POST['f_idcard']. "','" .$_POST['f_telephone']. "','" .$_POST['f_email']. "','" .$_POST['f_address']. "','" .$_POST['f_province']. "','" .$_POST['f_moo']. "','" .$_POST['f_mooban']. "','" .$_POST['f_placefocus']. "','" .$_POST['f_lat']. "','" .$_POST['f_lng']. "','" .$_POST['f_dateInput']. "','" .$_SERVER['REMOTE_ADDR']. "','1','1','0','".$_POST['f_key']."')";

            $rs = rsQuery($sql);

            if ($rs) {
                echo "<script>alert('แจ้งขอรับบริการเก็บขยะมูลฝอยเรียบร้อยค่ะ');window.location.href='index.php?_mod=" . $_GET['_mod'] . "';</script>";//
            }else{
...
//            echo "<script>alert('Send Mail OK')</script>";
            ...
            for($i=0; $i<count($_FILES['f_image']['name']); $i++){
                ...
                $filepath = "fileupload/garbage_request/confirm/".$newname;
            ...
            $sql = "INSERT INTO tb_garbage_request_confirm(id,code,name,id_card,telephone,email,address,province,moo,mooban,placefocus,pole_id,lat,lng,datepost,ip,typewb,status,updatetime,image_key) Values('',1,'".$_POST['f_name']. "','" .$_POST['f_idcard']. "','" .$_POST['f_telephone']. "','" .$_POST['f_email']. "','" .$_POST['f_address']. "','" .$_POST['f_province']. "','" .$_POST['f_moo']. "','" .$_POST['f_mooban']. "','" .$_POST['f_placefocus']. "','" .$_POST['f_poleid']. "','" .$_POST['f_lat']. "','" .$_POST['f_lng']. "','" .$_POST['f_dateInput']. "','" .$_SERVER['REMOTE_ADDR']. "','1','1','0','".$_POST['f_key']."')";
            $rs = rsQuery($sql);
            $num = mysqli_fetch_array($rs);
            $lid = $num['id'];
            if ($rs) {
                $sql2 = "SELECT * FROM tb_garbage_request_confirm ORDER BY id DESC LIMIT 0,1";
                $rss = rsQuery($sql2);
                ...
                $fields     = "message=มีผู้แจ้งขอรับบริการจัดเก็บขนะมูลฝอย ชื่อ $name เลขบัตร $idcard เบอร์โทร $telephone 
                ...
                echo "<script>alert('สามารถตรวจสอบถานะการขอรับบริการเก็บขยะมูลฝอย เลขที่:" .$lid."');window.location.href='index.php?_mod=" . $_GET['_mod'] . "';</script>";
...
<?php
$sql = "select * from tb_garbage_request_confirm order by id desc LIMIT 1";
$rs = rsQuery($sql);
$rs->num_rows;
$row = $rs->fetch_assoc();
    ...
    <div class="col-md-12">
        ...
        <form name="form_help" id="form_help" method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="col-sm-10">
                    <label class="control-label"><b>วันที่แจ้งขอรับบริการจัดเก็บขยะมูลฝอย:</b></label>
                    <?php echo date("Y-m-d");?>
            ...
            <h3 style="font-family: THK2DJuly8;">รายละเอียดสถานที่จัดเก็บขยะ</h3>
            <br>
            <h6 style="font-family: THK2DJuly8;">ข้าพเจ้ามีความประสงค์ขอใช้บริการจัดเก็บขยะมูลฝอย จาก <?php echo $customer_name ?> โดยชำระค่าธรรมเนียมบริการจัดเก็บขยะมูลฝอย</h6>
            <div class="form-group row">
                <div class="col-sm-3">
...
<!--            </div>-->
            ...
            <div class="form-group row">
                <div class="col-sm-10">
                    <label class="control-label"><b>ที่อยู่ของสถานที่ใช้บริการจัดเก็บขยะ หรือ จุดสังเกต</b></label>
            ...
            <div class="form-group row">
                <div class="col-sm-10">
                    ...
                    <input type="hidden"  name="f_key" id="f_key" value="garbage_confirm_<?php echo $newid; ?>">
                </div>
            </div>
