...
<div class="container">
    <div class="panel panel-default col-md-8">
        <h2>ข้อมูลแจ้งขออนุญาตก่อสร้างอาคาร</h2>
        <div class="panel-body">
            <p>เลขที่แจ้งขออนุญาต : <?php echo $row['id'];?></p>
            ...
            <p>ที่อยู่แจ้งอนุญาตก่อสร้างอาคาร : <?php echo $row['pole_id'];?></p>
            <p>บริเวณ/จุดสังเกต: <?php echo $row['placefocus'];?></p>
