...
<form name="form_fifa" id="inputArea" action="" method="POST" enctype="multipart/form-data"  onSubmit="return Chkfrm()">
	<fieldset>
		...
		<label style="margin-left: -2%" for="txtsubject" class="label">เรื่อง <font color="red">*</font> </label>
		<input type="text" name="txtsubject"/><br>
		<label style="margin-left: -7.4%" for="txtname" class="label">ชื่อ-นามสกุล <font color="red">*</font></label>
		<input type="text" name="txtname"/><br>
		<label style="margin-left: -11%" for="txtpsnid" class="label">เลขบัตรประชาชน <font color="red">*</font></label>
		<input type="text" name="txtpsnid"/><br>
		<label style="margin-left: -4.2%" for="txttel">โทรศัพท์ <font color="red">*</font></label>
		<input type="text" name="txttel"/><br>
		<label style="margin-left: -0.5%" for="txtemail">อีเมล์</label>
		<input type="text" name="txtemail"/><br>
		<label for="txtmoo">ที่อยู่</label>
		<input type="text" size="50" name="txtadd_address" placeholder="บ้านเลขที่/ซอย/ถนน/ตำบล/อำเภอ">
	...
	<fieldset>
		<legend>รายละเอียด</legend>
			<br>
				...
				<?php
					echo "<select name=\"txtmoo\" id=\"txtmoo\" style=\"width:70px;\"><option value=\"\">เลือก</option>";
					for($i=1;$i<=10;$i++){
