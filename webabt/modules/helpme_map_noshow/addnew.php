        ...
        if ($_POST['f_subject'] == "") {
            "T1";
					...
					#EMAIL---------------------------------------------------------------------------------------------------------------------------------------
						...
						$sql = "INSERT INTO tb_help_maps(id,subject,detail,result,lat,lng,postby,address,email,datepost,ip,typewb,status,updatetime)
...
<div class="container" style="text-align: left;">
    ...
    <form name="form_help" id="form_help" method="POST" action="" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <div class="col-sm-10">
                <label class="control-label"><b>ข้าพเจ้าชื่อ:</b><small style="color: red">**จำเป็น**</small></label>
            <input type="text" class="form-control" id="f_name" name="f_name" required oninvalid="this.setCustomValidity('กรุณากรอกชื่อค่ะ')"
                   oninput="setCustomValidity('')">
            </div>
        </div>
        <div class="form-group">
            <div class="col-sm-10">
            <label class="control-label"><b>ที่อยู่:</b><small style="color: red">**จำเป็น**</small></label>
            <input type="text" class="form-control" id="f_address" name="f_address" required  oninvalid="this.setCustomValidity('กรุณากรอกที่อยู่ค่ะ')"
                   oninput="setCustomValidity('')">
            </div>
        </div>
        <div class="form-group">
            <div class="col-sm-10">
            <label class="control-label"><b>อีเมล์/เบอร์ติดต่อ:</b><small style="color: red">**จำเป็น**</small></label>
            <input type="text" class="form-control" id="f_email" name="f_email" required oninvalid="this.setCustomValidity('กรุณากรอกอีเมล์หรือเบอร์ติดต่อค่ะ')"
                   oninput="setCustomValidity('')">
            </div>
        </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="f_subject" name="f_subject" required oninvalid="this.setCustomValidity('กรุณากรอกชื่อเรื่องค่ะ')"
                       oninput="setCustomValidity('')">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea type="text" class="form-control" id="f_detail" name="f_detail" required oninvalid="this.setCustomValidity('กรุณาใส่รายละเอียดค่ะ')"
