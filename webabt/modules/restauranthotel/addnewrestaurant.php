...
//            echo "<script>alert('Send Mail OK')</script>";
            ...
            for($i=0; $i<count($_FILES['f_image']['name']); $i++){
                ...
                $newname = "REST_".$_POST['id'].'_'.$i.'.'.$ext;
                $filetmp = $_FILES["f_image"]["tmp_name"][$i];
                $filetype = $_FILES["f_image"]["type"][$i];
                $filepath = "fileupload/restaurantreg/".$newname;
            ...
            $sql = "INSERT INTO tb_restaurantreg(id,reg_type,name,name_eng,res_type,menu_rec,open_date_range,time_start,time_end,price_range,address,telephone,line_id,fb_page,lat,lng,partnergrab,partnerfp,partnerlm,serv_alcohol,serv_queue,serv_government,datepost,ip,typewb,status,updatetime,image_key) Values('','1','".$_POST['f_name']. "','" .$_POST['f_name_eng']. "','" .$_POST['f_res_type']. "','" .$_POST['f_menu_rec']. "','" .$_POST['f_open_date_range']. "','" .$_POST['f_time_start']. "','" .$_POST['f_time_end']. "','" .$_POST['f_price_range']. "','" .$_POST['f_address']. "','" .$_POST['f_telephone']. "','" .$_POST['f_line_id']. "','" .$_POST['f_fb_page']. "','" .$_POST['f_lat']. "','" .$_POST['f_lng']. "','" .$_POST['partnergrab']. "','" .$_POST['partnerfp']. "','" .$_POST['partnerlm']. "','" .$_POST['serv_alcohol']. "','" .$_POST['serv_queue']. "','" .$_POST['serv_government']. "','" .$_POST['f_dateInput']. "','" .$_SERVER['REMOTE_ADDR']. "','1','1','1','".$_POST['f_key']."')";
            $rs = rsQuery($sql);
            echo $rs;
            $num = mysqli_fetch_array($rs);
            $lid = $num['id'];
            if ($rs) {
                $sql2 = "SELECT * FROM tb_restaurantreg ORDER BY id DESC LIMIT 0,1";
                $rss = rsQuery($sql2);
...
<?php
$sql = "select * from tb_restaurantreg order by id desc LIMIT 1";
$rs = rsQuery($sql);
$rs->num_rows;
$row = $rs->fetch_assoc();
...
<div class="container" style="text-align: left;">
    <div class="col-md-12">
        ...
        <form name="form_help" id="form_help" method="POST" action="" enctype="multipart/form-data">
            ...
            <h3 style="font-family: THK2DJuly8;">ข้อมูลร้านอาหาร</h3>
            <div class="form-group row">
                <div class="col-sm-5">
                    <label class="control-label"><b>ชื่อร้านอาหาร:</b></label>
                    <input type="text" class="form-control" id="f_name" name="f_name" required>
                </div>
                <div class="col-sm-5">
                    <label class="control-label"><b>ชื่อร้านภาษาอังกฤษ:</b></label>
...
<!--            </div>-->
            ...
            <div class="form-group row">
                <div class="col-sm-10">
                    <label class="control-label"><b>ประเภทร้านอาหาร:</b></label>
                    <select id="f_res_type" name="f_res_type" class="form-control" required>
                        <option value="" selected>กรุณาเลือก</option>
                        <option <?php if($selected2 == '1'){echo("selected");}?> value="1">อาหารทั่วไป อาหารตามสั่ง อาหารจานเดียว</option>
                        <option <?php if($selected2 == '2'){echo("selected");}?> value="2">ก๋วยเตี๋ยว ก๋วยจั๊บ</option>
                        <option <?php if($selected2 == '3'){echo("selected");}?> value="3">ชาบู สุกี้ยากี้ หม้อไฟ</option>
                        <option <?php if($selected2 == '4'){echo("selected");}?> value="4">ปิ้งย่าง หมูกะทะ</option>
                        <option <?php if($selected2 == '5'){echo("selected");}?> value="5">ของหวาน ไอศกรีม เบเกอรี่ เครื่องดื่ม</option>
                        <option <?php if($selected2 == '6'){echo("selected");}?> value="6">ร้านขายผลไม้ / ร้านขายผัก</option>
                        <option <?php if($selected2 == '7'){echo("selected");}?> value="7">ร้านอาหารอีสาน</option>
                        <option <?php if($selected2 == '8'){echo("selected");}?> value="8">ร้านอาหารญี่ปุ่น</option>
                        <option <?php if($selected2 == '9'){echo("selected");}?> value="9">คาราโอเกะ</option>
                        <option <?php if($selected2 == '10'){echo("selected");}?> value="10">บุฟเฟ่ต์</option>
                        <option <?php if($selected2 == '11'){echo("selected");}?> value="11">บุฟเฟ่ต์โรงแรม</option>
                        <option <?php if($selected2 == '12'){echo("selected");}?> value="12">พิซซ่า ฟาสต์ฟู้ด จานด่วน</option>
                        <option <?php if($selected2 == '13'){echo("selected");}?> value="13">อาหารเกาหลี</option>
                        <option <?php if($selected2 == '14'){echo("selected");}?> value="14">อาหารจีน</option>
                        <option <?php if($selected2 == '15'){echo("selected");}?> value="15">อาหารเจ มังสวิรัติ สุขภาพ</option>
                        <option <?php if($selected2 == '16'){echo("selected");}?> value="16">อาหารใต้</option>
                        <option <?php if($selected2 == '17'){echo("selected");}?> value="17">อาหารทะเล</option>
                        <option <?php if($selected2 == '18'){echo("selected");}?> value="18">อาหารนานาชาติ</option>
                        <option <?php if($selected2 == '19'){echo("selected");}?> value="19">อาหารมุสลิม อิสลาม</option>
                        <option <?php if($selected2 == '20'){echo("selected");}?> value="20">อาหารเวียดนาม</option>
                        <option <?php if($selected2 == '21'){echo("selected");}?> value="21">อาหารอินเดีย</option>
                        <option <?php if($selected2 == '22'){echo("selected");}?> value="22">อาหารเหนือ</option>
                        <option <?php if($selected2 == '23'){echo("selected");}?> value="23">อาหารว่าง ขนม ของกินเล่น</option>
                        <option <?php if($selected2 == '24'){echo("selected");}?> value="24">อื่นๆ</option>
                    </select>
                </div>
            </div>
            <div class="form-group row">
                <div class="col-sm-10">
                    <label class="control-label"><b>เมนูแนะนำ:</b></label>
                    <input type="text" class="form-control" id="f_menu_rec" name="f_menu_rec" required>
                </div>
            </div>
            <div class="form-group row">
                <div class="col-sm-6">
            ...
            <div class="form-group row">
                <div class="col-sm-3">
                    <label class="control-label"><b>เวลาเปิด:</b></label>
                    <input type="time" class="form-control" id="f_time_start" name="f_time_start">
                </div>
                <div class="col-sm-3">
                    <label class="control-label"><b>เวลาปิด:</b></label>
                    <input type="time" class="form-control" id="f_time_end" name="f_time_end">
                </div>
            </div>
            <div class="form-group row">
                <div class="col-sm-10">
                    <label class="control-label"><b>ช่วงราคาโดยประมาณ:</b></label>
                    <input type="text" class="form-control" id="f_price_range" name="f_price_range" placeholder="เช่น 100 - 250 บาท">
                </div>
            </div>
            <div class="form-group row">
                <div class="col-sm-10">
            ...
            <div class="form-group row">
                <div class="col-sm-10">
                    <label class="control-label"><b>เฟสบุ๊คแฟนเพจ (Fanpage):</b></label>
                    <input type="text" class="form-control" id="f_fb_page" name="f_fb_page" placeholder="">
                </div>
            </div>
            <div class="form-group row">
                <div class="col-sm-4">
...
<!--            </div>-->
            ...
            <div class="form-group row">
                <div class="col-sm-10">
                    <label class="control-label"><b>การให้บริการ:</b></label>
                    <input type="checkbox" id="serv_alcohol" name="serv_alcohol" value="1">
                    <label class="control-label"><b>แอลกอฮอล์</b></label>
                    <input type="checkbox" id="serv_queue" name="serv_queue" value="1">
                    <label class="control-label"><b>จองล่วงหน้า</b></label>
                    <input type="checkbox" id="serv_government" name="serv_government" value="1">
                    <label class="control-label"><b>เข้าร่วมโครงการรัฐบาล (เช่น โครงการคนละครึ่ง)</b></label>
                </div>
            </div>
            ...
            <div class="form-group row">
                <div class="col-sm-10">
                    <label class="control-label"><b>เพิ่มรูปภาพร้านอาหาร:</b></label>
                    <input type="file"  name="f_image[]" id="f_image[]" multiple required>
                    <input type="hidden"  name="f_key" id="f_key" value="777<?php echo $newid; ?>">
                </div>
            </div>
            ...
            <label class="control-label"><b>กรุณาระบุตำแหน่งร้านอาหารบนแผนที่:</b></label>
            <div id="map2"></div>
