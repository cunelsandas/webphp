<div id="file">
		...
		<?php
			...
			$sql1="Select * From tb_submenu Where id=".$type;
...
if($no<>""){
	...
	$sql = "select * from $tablename Where filetypeid=$type And status='1' order by datepost DESC,no DESC Limit $goto,$pagelen"; //ทำการแสดงผลโดยใช้คำสั่ง Limit
