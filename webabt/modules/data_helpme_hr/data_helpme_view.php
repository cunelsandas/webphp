...
<table width="100%" border="0" align="center">
    <tr>
        <td valign='top'>
            ...
            <?php
            $strSql = "select * from filename where tablename='$tablename' AND masterid='" . $row['id'] . "' Order by id ASC";
            $strSql2 = "select * from filename where tablename='$tablename' AND masterid='" . $row['id'] . "' Order by id ASC";
            $rs2 = rsQuery($strSql);
            if ($rs2) {
...
//                            echo '<a href="' . $foldername . $rs_filename['filename'] . '" target="_blank"><img width="80" height="80" src="images/pdf.gif"></a>&nbsp;&nbsp;';
                            ...
                            echo "<a href=" . $foldername . $rs_filename['filename'] . " target=\"_blank\"><img src=" . $foldername . $rs_filename['filename'] . " width=\"150\" height=150  /></a>&nbsp;&nbsp;";
                        }
                    } else {
                        if ($default_image == "0") {
