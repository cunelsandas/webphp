...
//            echo "<script>alert('Send Mail OK')</script>";
            ...
            if ($rs) {
                ...
                $lid = $num['id'];
                echo "<script>alert('สามารถตรวจสอบได้ด้วยเลขที่ชำระภาษี  เลขที่:" .$lid."');window.location.href='index.php?_mod=" . $_GET['_mod'] . "';</script>";
...
<!--            </div>-->
            ...
            <div class="form-group">
                <div class="col-sm-10">
                    ...
                    <select id="f_taxtype" name="f_taxtype" class="form-control">
                        <option selected>กรุณาเลือก</option>
                        <option <?php if($selected2 == '1'){echo("selected");}?> value="1">ภาษีที่ดินและสิ่งปลูกสร้าง</option>
                        <option <?php if($selected2 == '2'){echo("selected");}?> value="2">ภาษีป้าย</option>
                    </select>
                </div>
            </div>
            <div class="form-group">
...
<!--            </div>-->
            ...
            <div class="form-group">
                <div class="col-sm-10">
                    ...
                    <input type="hidden"  name="f_key" id="f_key" value="paytax_<?php echo $newid; ?>">
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="col-sm-10">
                    ...
                    <input type="datetime-local" class="form-control" id="f_paydatetime" name="f_paydatetime" required>
                </div>
            </div>
...
<!--            </div>-->
    ...
    <center><button type="submit" name="sub" class="btn btn-success">บันทึก</button></center>
    </form>
