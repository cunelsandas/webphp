...
if(isset($_POST['btwb'])){
	...
	if($chkver<>$_POST['txtver']){
		...
		$psnid=EscapeValue($_POST['txtpsnid']);

		$sql="INSERT INTO tb_wb_mas(subject,detail,postby,psnid,datepost,ip,status,deleted,createdate) Values('$subject','$detail1','$postby','$psnid','$dt2','".$_SERVER['REMOTE_ADDR']."','1','0','$dt')";
		$rs=rsQuery($sql);
		if($rs){
...
<tr >
	...
	<td  align=left><input type="text" name="txtpsnid"  size="30" id="txtpsnid" /></td>
</tr>
<tr >
