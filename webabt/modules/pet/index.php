...
if($type=="addnew"){
    ...
    include "/var/www/share/webabt/modules/pet/view.php";
}else{
	?>
	<div valign="top"><?php echo"<a class='btn btn-success' href=\"index.php?_mod=".$_GET['_mod']."&type=addnew \">ลงทะเบียนสัตว์เลี้ยง</a>";?></div><br>
    ...
    <div>
        <table id="example" class="table table-striped table-bordered" style="width:100%;background-color: white">
            <thead>
            <tr>
                <th>เลขที่ลงทะเบียนสัตว์เลี้ยง</th>
            ...
            <tbody>
                ...
                $sql = "select * from tb_pet WHERE status='1'";
                $rs = rsQuery($sql);
                $n = 0;
