...
echo "<center>";
	if(file_exists("images/".$bannername) and $bannername<>""){
			...
			echo "<p style='font-weight: bolder;text-decoration: underline;font-size: 20px'>เบอร์โทร 1669</p>";
            echo "<p style='font-weight: bolder;text-decoration: underline;font-size: 20px'> เบอร์โทรสายตรงเทศบาล 0819606815</p>";
	}
echo "</center>";
...
while($arr = mysqli_fetch_assoc($Query)){
	...
	$depname=FindRS("select name from tb_officertype1669 where id=".$arr['offid'],"name");
