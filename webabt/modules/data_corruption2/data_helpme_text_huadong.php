...
if($type=="addnew"){
	...
	$name_btn = "แจ้งเรื่องร้องเรียนการทุจริต";
...
$folder=FindRS("select * from tb_mod where modtype='$mod'","foldername");
	...
	if($device=="Mobile"){
		echo"<a href='view.php' class='link' target='_blank'>".$modname."</a>";
	}else{
		echo"<a href=\"index.php?_mod=".$_GET['_mod']."&type=".encode64('addnew')." \" class='link'>".$modname."</a>";
	}


					?></div><br>
    <div style="border: 1px solid black;border-radius: 12px;width: 80%;">
   <p style="text-decoration: underline">ช่องทางการร้องเรียน/แจ้งเบาะแส </p>
    <p> 1) ร้องเรียนด้วยตนเอง ที่ศูนย์ปฏิบัติการต่อต้านการทุจริตเทศบาลตำบลหัวดง </p>
    <p>   ๒) ทางไปรษณีย์ (ที่อยู่ 223 หมู่ 2 สำนักงานเทศบาลตำบลหัวดง  อำเภอลับแล  จังหวัดอุตรดิตถ์  53130) </p>
    <p>   ๓) ร้องเรียนทางโทรศัพท์ หมายเลข ๐ 5542 7222 </p>
    <p>    ๔) ตู้รับเรื่องร้องเรียน/ร้องทุกข์ เทศบาลตำบลหัวดง</p>
    <p>    ๕) เว็ปไซต์ <a href="http://www.huadong.go.th">http://www.huadong.go.th</a>  </p>
        <p>   ๖) Facebook : <a href="https://www.facebook.com/huadongza">เทศบาลตำบลหัวดง</a> </p>
    <p>    ๗) สายตรงนายกเทศมนตรีตำบลหัวดง 08 2163 3133</p>
    </div>
    <br>
	<div id="master-table">
