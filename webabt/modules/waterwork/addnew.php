...
//            echo "<script>alert('Send Mail OK')</script>";
            ...
            $lid = $num['id'];
            if ($rs) {
                $sql2 = "SELECT * FROM tb_waterwork ORDER BY id DESC LIMIT 0,1";
                $rss = rsQuery($sql2);
                $num = mysqli_fetch_array($rss);
                $lid = $num['id'];
                echo "<script>alert('สามารถตรวจสอบสถานะแจ้งซ่อมประปาได้ที่ เลขที่:" . $lid . "');window.location.href='index.php?_mod=" . $_GET['_mod'] . "';</script>";
...
<div class="container" style="text-align: left;">
    <div class="col-md-12">
        ...
        <form name="form_help" id="form_help" method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="col-sm-10">
                    <label class="control-label"><b>วันที่แจ้งซ่อมประปาสาธารณะ:</b></label>
                    <?php echo date("Y-m-d"); ?>
            ...
            <div class="form-group row">
                <div class="col-sm-10">
                    ...
                    <input type="text" class="form-control" id="f_idcard" name="f_idcard" onKeyPress="CheckNum()"
            ...
            <div class="form-group row">
                <div class="col-sm-10">
                    ...
                    <input type="text" class="form-control" id="f_address" name="f_address"
                           placeholder="เลขที่ ถนน ซอย หมู่ ตำบล อำเภอ">
                </div>
            </div>
            <div class="form-group row">
                <div class="col-sm-4">
            ...
            <h3 style="font-family: THK2DJuly8;">รายละเอียดแจ้งซ่อม</h3>
            <br>
            <h6 style="font-family: THK2DJuly8;">ข้าพเจ้ามีความประสงค์ให้ <?php echo $customer_name ?>
                ซ่อมแซมประปาสาธารณะ</h6>
            <div class="form-group row">
                <div class="col-sm-3">
            ...
            <div class="form-group row">
                <div class="col-sm-10">
                    ...
                    <input type="text" class="form-control" id="f_placefocus" name="f_placefocus" required
                           placeholder="เช่น บริเวณโรงเรียน...">
                </div>
            </div>

            <div class="form-group row">
                <div class="col-sm-10">
                    <label class="control-label"><b>เพิ่มรูปจุดที่ต้องการซ่อมประปาสาธารณะ:</b></label>
                    <input type="file" name="f_image[]" id="f_image[]" multiple required>
                    <input type="hidden" name="f_key" id="f_key" value="waterwork_<?php echo $newid; ?>">
                </div>
            </div>
    ...
    <p><b>หมายเหตุ</b> : เพื่อให้การแก้ไขปัญหาประปาสาธาณะของหมู่บ้านเป็นไปด้วยความรวดเร็ว ทันต่อสถานการณ์
        ท่านสามารถแจ้งคณะกรรมการบริหารประปาประจำหมู่บ้านเพื่อขอรับบริการดังกล่าว</p>

    <center>
        <button type="submit" name="sub" class="btn btn-success">ส่งคำร้อง</button>
    </center>
    </form>
