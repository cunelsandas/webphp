...
if($type=="addnew"){
    ...
    include "/var/www/share/webabt/modules/waterwork/view.php";
}else{
	?>
	<div valign="top"><?php echo"<a class='btn btn-success' href=\"index.php?_mod=".$_GET['_mod']."&type=addnew \">แจ้งซ่อมประปาสาธารณะ</a>";?></div><br>
