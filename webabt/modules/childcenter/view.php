...
//                    echo "<td>" . 'ภาษีป้าย' . "</td>";
//                } ?><!--</p>-->
            <p>ชื่อ : <?php echo $row['child_name']. ' '.$row['child_surname'];?></p>
            <p>ชื่อภาษาอังกฤษ : <?php echo $row['child_name_eng']. ' '.$row['child_surname_eng'];?></p>
            <p>วัน/เดือน/ปีเกิด: <?php echo datethai($row['child_birth_date']);?></p>
            ...
            <p>เพศ : <?php
                ...
                ?></p>
            <hr>
            <h4 style="text-decoration: underline">ข้อมูลบิดา</h4>
            <p>ชื่อ : <?php echo $row['father_name']. ' '.$row['father_surname'];?></p>
            <p>วัน/เดือน/ปีเกิด: <?php echo datethai($row['birthdate_father']);?></p>
            <p>อายุ: <?php echo $row['age_father'].' ปี ';?></p>
            <hr>
            <h4 style="text-decoration: underline">ข้อมูลมารดา</h4>
            <p>ชื่อ : <?php echo $row['mother_name']. ' '.$row['mother_surname'];?></p>
            <p>วัน/เดือน/ปีเกิด: <?php echo datethai($row['birthdate_mother']);?></p>
            <p>อายุ: <?php echo $row['age_mother'].' ปี ';?></p>
            <hr>
            <p>สถานะการลงทะเบียน : <b><?php echo $processname ;?></b>
        </div>
    </div>
