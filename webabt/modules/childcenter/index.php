...
if($type=="addnew"){
    ...
    include "/var/www/share/webabt/modules/childcenter/view.php";
}else{
	?>
	<div valign="top"><?php echo"<a class='btn btn-success' href=\"index.php?_mod=".$_GET['_mod']."&type=addnew \">ลงทะเบียนศูนย์พัฒนาเด็กเล็ก</a>";?></div><br>
    ...
    <div>
        <table id="example" class="table table-striped table-bordered" style="width:100%;background-color: white">
            <thead>
            <tr>
                <th>เลขที่ลงทะเบียนศูนย์เด็กฯ</th>
            ...
            <tbody>
                ...
                $sql = "select * from tb_childcenter_reg WHERE status='1'";
                $rs = rsQuery($sql);
                $n = 0;
