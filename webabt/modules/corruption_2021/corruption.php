          ...
          <div class="col-12 col-12-medium">
              ...
              <form method="post" action="#" onsubmit="return(validate());" name="myForm" enctype="multipart/form-data">
                ...
                <div class="row gtr-uniform">
                  ...
                  <div class="col-8 col-12-xsmall mt-1" style="margin: 0 auto;">
                    <input class="form-control" type="text" name="frm_address" id="frm_address" value="" placeholder="ที่อยู่ บ้านเลขที่ ตำบล/แขวง อำเภอ/เขต จังหวัด" />
                  </div>
                  <div class="col-8 col-12-xsmall mt-1" style="margin: 0 auto">
...
<!--                  </div>-->
                    ...
                    <div class="col-12 col-12-xsmall" style="margin: 0 auto">
                        <input class="form-control" type="text" name="frm_subject" id="frm_subject" placeholder="เรื่องที่ต้องการร้องเรียน"/>
                    </div>
                  ...
                  <div class="col-8 col-12-xsmall mt-1" style="margin: 0 auto">
                    <input class="form-control" type="text" name="frm_corrupt_person" id="frm_corrupt_person" placeholder="ชื่อ-นามสกุล หรือรายละเอียดบุคคลที่ท่านร้องเรียน">
                  </div>
                    <div class="col-12 col-12-xsmall mt-1" style="margin: 0 auto">
                    <textarea class="form-control" rows="10" name="frm_detail" id="frm_detail" placeholder="รายละเอียด"></textarea>
                    </div>
...
<!--                    <input class="form-control" type="time" name="frm_date_end" id="frm_date_end" />-->
                  ...
                  <div class="col-4" style="margin:2% auto;" >
                    <ul class="actions">
                      <input class="form-control bg-primary" type="submit" name="Submit" value="ยืนยัน" class="primary" /></li>
