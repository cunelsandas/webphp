...
//            echo "<script>alert('Send Mail OK')</script>";
            ...
            for($i=0; $i<count($_FILES['f_image']['name']); $i++){
                ...
                $filepath = "fileupload/restauranthotel/".$newname;
            ...
            $sql = "INSERT INTO tb_restauranthotel(id,postby,id_card,telephone,email,age_year,age_month,pet_type,pet_species,pet_color,pet_sterilize,pet_from,date_vaccine,adress,lat,lng,datepost,ip,typewb,status,updatetime,image_key,image_key_idcard) Values('','".$_POST['f_name']. "','" .$_POST['f_idcard']. "','" .$_POST['f_telephone']. "','" .$_POST['f_email']. "','" .$_POST['f_age_year']. "','" .$_POST['f_age_month']. "','" .$_POST['f_pettype']. "','" .$_POST['f_species']. "','" .$_POST['f_color']. "','" .$_POST['f_sterilize']. "','" .$_POST['f_petfrom']. "','" .$_POST['f_vaccine']. "','" .$_POST['f_address']. "','" .$_POST['f_lat']. "','" .$_POST['f_lng']. "','" .$_POST['f_dateInput']. "','" .$_SERVER['REMOTE_ADDR']. "','1','1','0','".$_POST['f_key']."','".$_POST['f_key_idcard']."')";
            $rs = rsQuery($sql);
            $num = mysqli_fetch_array($rs);
            $lid = $num['id'];
            if ($rs) {
                $sql2 = "SELECT * FROM tb_restauranthotel ORDER BY id DESC LIMIT 0,1";
                $rss = rsQuery($sql2);
        ...
        <form name="form_help" id="form_help" method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                <div class="col-sm-10">
                    ...
                    <input type="hidden"  name="f_key" id="f_key" value="900<?php echo $newid; ?>">
                </div>
            </div>
            <div class="form-group row">
                <div class="col-sm-10">
            ...
            <div class="form-group row">
                <div class="col-sm-10">
                    ...
                    <select id="f_pettype" name="f_pettype" class="form-control" required>
                        ...
                        <option <?php if($selected2 == '3'){echo("selected");}?> value="2">ชาบู สุกี้ยากี้ หม้อไฟ</option>
                        <option <?php if($selected2 == '4'){echo("selected");}?> value="2">ปิ้งย่าง หมูกะทะ</option>
                        <option <?php if($selected2 == '5'){echo("selected");}?> value="2">ของหวาน ไอศกรีม เบเกอรี่ เครื่องดื่ม</option>
                        <option <?php if($selected2 == '6'){echo("selected");}?> value="2">ร้านขายผลไม้ / ร้านขายผัก</option>
                        <option <?php if($selected2 == '7'){echo("selected");}?> value="2">ร้านอาหารอีสาน</option>
                        <option <?php if($selected2 == '8'){echo("selected");}?> value="2">ร้านอาหารญี่ปุ่น</option>
                        <option <?php if($selected2 == '9'){echo("selected");}?> value="2">คาราโอเกะ</option>
                        <option <?php if($selected2 == '10'){echo("selected");}?> value="2">บุฟเฟ่ต์</option>
                        <option <?php if($selected2 == '11'){echo("selected");}?> value="2">บุฟเฟ่ต์โรงแรม</option>
                        <option <?php if($selected2 == '12'){echo("selected");}?> value="2">พิซซ่า ฟาสต์ฟู้ด จานด่วน</option>
                        <option <?php if($selected2 == '13'){echo("selected");}?> value="2">อาหารเกาหลี</option>
                        <option <?php if($selected2 == '14'){echo("selected");}?> value="2">อาหารจีน</option>
                        <option <?php if($selected2 == '15'){echo("selected");}?> value="2">อาหารเจ มังสวิรัติ สุขภาพ</option>
                        <option <?php if($selected2 == '16'){echo("selected");}?> value="2">อาหารใต้</option>
                        <option <?php if($selected2 == '17'){echo("selected");}?> value="2">อาหารทะเล</option>
                        <option <?php if($selected2 == '18'){echo("selected");}?> value="2">อาหารนานาชาติ</option>
                        <option <?php if($selected2 == '19'){echo("selected");}?> value="2">อาหารมุสลิม อิสลาม</option>
                        <option <?php if($selected2 == '20'){echo("selected");}?> value="2">อาหารเวียดนาม</option>
                        <option <?php if($selected2 == '21'){echo("selected");}?> value="2">อาหารอินเดีย</option>
                        <option <?php if($selected2 == '22'){echo("selected");}?> value="2">อาหารเหนือ</option>
                        <option <?php if($selected2 == '23'){echo("selected");}?> value="2">อาหารว่าง ขนม ของกินเล่น</option>
                        <option <?php if($selected2 == '24'){echo("selected");}?> value="2">อื่นๆ</option>
                    </select>
                </div>
            </div>
            <div class="form-group row">
