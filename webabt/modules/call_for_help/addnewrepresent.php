...
//            echo "<script>alert('Send Mail OK')</script>";
            ...
            $sql = "INSERT INTO tb_call_for_help(id,call_ask_type,title_name,firstname,lastname,age,idcard,home_num,moo,road,tambon,amphoe,province,telephone,title_name_co,firstname_co,lastname_co,call_help_type,detail_call_type,detail_call_help,f_lat,f_lng,datepost,ip,typewb,status,updatetime,image_key)Values('','2','" . $_POST['title_name'] . "','" . $_POST['firstname'] . "','" . $_POST['lastname'] . "','" . $_POST['age'] . "','" . $_POST['idcard'] . "','" . $_POST['home_num'] . "','" . $_POST['moo'] . "','" . $_POST['road'] .
                "','" . $_POST['tambon'] . "','" . $_POST['amphoe'] . "','" . $_POST['province'] . "','" . $_POST['telephone'] . "','" . $_POST['title_name_co'] . "','" . $_POST['firstname_co'] . "','" . $_POST['lastname_co'] .
                "','" . $_POST['call_help_type'] . "','" . $_POST['detail_call_type'] . "','" . $_POST['detail_call_help'] . "','" . $_POST['f_lat'] . "','" . $_POST['f_lng'] . "','" .$_POST['f_dateInput']. "','" .$_SERVER['REMOTE_ADDR']. "','1','1','1','".$_POST['f_key']."')";
            $rs = rsQuery($sql);
            echo $rs;
...
<div class="container" style="text-align: left;">
    <div class="col-md-12">
        ...
        <form name="form_help" id="form_help" method="POST" action="" enctype="multipart/form-data">
            ...
            <h4 style="text-decoration: underline">แบบลงทะเบียนขอรับความช่วยเหลือของประชาชน (กรณีร้องขอด้วยผู้แทน)</h4>
            ...
            <h5>มีความประสงค์ขอให้ <?php echo $customer_name ?> ดำเนินการช่วยเหลือ</h5>
            <div class="form-group row">
                <div class="col-sm-7">
                    <label class="control-label"><b>ชื่อ-นามสกุล ผู้รับความช่วยเหลือ:</b></label>
                    <input type="text" class="form-control" id="helper_recipient" name="helper_recipient" required>
                </div>
            </div>
            <div class="form-group row">
                <div class="col-sm-7">
