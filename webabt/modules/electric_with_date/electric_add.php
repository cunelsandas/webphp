<?php
	...
	$point_no="5";
	$file_no=($gloNews_fileno-2);   // กำหนด array จำนวน file ที่ต้องการ  $glo...มาจากไฟล์ connect.ini.php
...
function Chkfrm()
         {
				...
				var obj8 = document.form_fifa.txtpsnid;
                 var obj9 = document.form_fifa.txt_dateadd;
		...
		if (obj0.value.length==0)
		{
           ...
           return false;
			...
			obj8.focus();
			return false;
        } else if (obj9.value.length==0){
            alert('กรุณาใส่วันที่แจ้ง');
            obj9.focus();
            return false;
		}else{
			return true;
...
<form name="form_fifa" id="inputArea" action="" method="POST" enctype="multipart/form-data"  onSubmit="return Chkfrm()">
	<fieldset>
        ...
        <label for="txt_dateadd" class="label">วันที่แจ้ง <font color="red">*</font> </label>
        <input type="date" name="txt_dateadd"/>
        <br>
