...
//            echo "<script>alert('Send Mail OK')</script>";
            ...
            $sql = "INSERT INTO tb_electric_maps(id,name,id_card,telephone,email,address,province,moo,mooban,placefocus,pole_id,lat,lng,datepost,ip,typewb,status,updatetime,image_key) Values('','".$_POST['f_name']. "','" .$_POST['f_idcard']. "','" .$_POST['f_telephone']. "','" .$_POST['f_email']. "','" .$_POST['f_address']. "','" .$_POST['f_province']. "','" .$_POST['f_moo']. "','" .$_POST['f_mooban']. "','" .$_POST['f_placefocus']. "','" .$_POST['f_poleid']. "','" .$_POST['f_lat']. "','" .$_POST['f_lng']. "','" .$_POST['f_dateInput']. "','" .$_SERVER['REMOTE_ADDR']. "','1','1','0','".$_POST['f_key']."')";
            $rs = rsQuery($sql);
            $num = mysqli_fetch_array($rs);
            $lid = $num['id'];


            $sqlnoti = "INSERT INTO tb_notification(id,subject,detail,modid,master_id,allstatus,substatus)
                    Values('','" .$_POST['f_name']. "','" .$modname. "','" .$modid. "','" .$lid. "','0','0')";
            $rsnoti = rsQuery($sqlnoti);
