...
if($type=="addnew"){
    ...
    include "/var/www/share/webabt/modules/electric_maps/view.php";
}else{
	?>
	<div valign="top"><?php echo"<a class='btn btn-success' href=\"index.php?_mod=".$_GET['_mod']."&type=addnew \">แจ้งซ่อมไฟฟ้าสาธารณะ</a>";?></div><br>
    ...
    <div>
        <table id="example" class="table table-striped table-bordered" style="width:100%;background-color: white">
            ...
            <tbody>
                ...
                $sql = "select * from tb_electric_maps WHERE status='1'";
                $rs = rsQuery($sql);
                $n = 0;
